...
//                                                                                                                       //
// ompiled with 'g++ extract_emerging.cpp' and executed with './a.out'                                                   //
//                                                                                                                       //
//                                                                                                                       //
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
template <class T>           // Converts a string into a float or integer or whatever //
...
int main()
{
   ...
   //cout <<  "\033[40;0;31m TESTAUSGABE \033[40;0;34m KUNTER \033[40;0;32m BUNT \033[40;0;33m ANGESTRICHEN \033[0m" << endl;
   ...
   file_in = "Cutoffparameter_Hostaphan_alu_mitohne_vergleich/hostaphan_jn_vergleich/75deg_PMMA_500keV_6mm_plexi_vgl_0.1prozent_abs_eng_of_electr_ohne_SE/pe-trajectories.dat";     // inputfilename ('../../pe-trajectories.dat')                                   //
...
//   file_out5 = "extract_emerging/angle_probability.dat";              // Outputfilename for probability (bins) over angle                              //
 ...
 //  fstream energyangle(file_out8.c_str(), ios::out);
   ...
   if(dflag == 1) // dflag == 1 ... file has been opened without problems //
   {
      ...
      while ( !datei.eof() )
      {
         if (zeile[0] == '0' and getline(datei,zeile) != 0) // First char of string = '0' -> beginning of a new particle //
         {
            ...
            if (temparray[4] == "      1")  // "  1" -> Backscattered particle found //
            {
               // GET BACSCATTERED ENERGY OVER ANGULAR INFORMATION //
               flag1 = 0;
               ct1 = 0;
               ...
               while(flag1 == 0)
               {
                  ...
                  if (zeile[0] == '0')
                  {
                     if (ct1 > 3)  // prevents errors (backscattering with only one collission in the trajectoryfile) //
                     {
                       ...
                       if (nrg > energy_p){energy_p = nrg;} // energy_p ... peakenergy (the highest energy found from a backscattered particle //
            ...
            if (temparray[4] == "      2")  // "  2" -> Transmitted //
            {
...
cout << "CP: " << control_particle << " / energy_p/energybins: " << energy_p/energybins << endl;


cout << endl;
cout << endl;
cout << "control_float : " << control_fl_1 << endl;
cout << endl;
cout << endl;
cout << "backscat energy: " << backscattered_energy << "[eV]" << endl;
cout << endl;
cout << endl;
cout << "(backscat energy)/(total incident energy): " << backscattered_energy/(control_particle*energy_p) << " / " << control_particle*energy_p << endl;
cout << " c1: " << control1 << endl;
cout << "ep: " << energy_p << endl;
